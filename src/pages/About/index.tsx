  ...
  return (
    <>
      ...
      <C.Container>
        ...
        <C.AboutText>
          <C.Paragraph>Olá, meu nome é Igor, sou apaixonado por <C.Span>tecnologia</C.Span> e muitas nerdices, eu amo estudar sobre o <C.Span>desenvolvimento web</C.Span> e fico fascinado o quão rapido essa área evolui, isso me incentiva a estudar mais ainda.</C.Paragraph>
          <C.Paragraph>Já estou no final do meu curso na <C.Link href='https://www.betrybe.com/' target='_blank' rel='noreferrer'>Trybe</C.Link> que é uma escola de <C.Span>programação</C.Span> que tem o foco no desenvolvimento web <C.Span>full stack</C.Span>, que é exatamente o que desejo. Eu amo estudar tanto sobre <C.Span>frontend</C.Span> quanto o <C.Span>backend</C.Span>.</C.Paragraph>
